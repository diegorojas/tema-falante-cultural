				...
				<div class="ph-box">
					...
					<h1 class="home-heading"><a href="<?php echo home_url( '/categoria/cliques/' ); ?>" class="cliques-heading">CLIQUES</a></h1>
						...
						<h1 class="home-heading "><a href="<?php echo home_url( '/categoria/materias/' ); ?>" class="materias-heading">VER TODAS AS MAT&Eacute;RIAS</a></h1>
								...
								<div id="home-bloco4">
					<h1 class="home-heading"><a href="<?php echo home_url( '/categoria/classificados/' ); ?>" class="classificados-heading">CLASSIFICADOS</a></h1>
								<?php
								  // Adiciona o query de Classificados do Falante
								 get_template_part('loop-classificados');
								?>
								<h1 class="home-heading "><a href="<?php echo home_url( '/categoria/classificados/' ); ?>" class="classificados-heading">VER TODOS</a></h1>
					</div>
